...
public class Cliente {
	...
	public String toString() {
		return "Cliente [idadePrimitivo=" + idadePrimitivo + ", clienteAtivoPrimitivo=" + clienteAtivoPrimitivo
				...
				+ clienteAtivoWrapper + ", valorWrapper=" + valorWrapper + ", getIdadePrimitivo()="
				+ getIdadePrimitivo() + ", isClienteAtivoPrimitivo()=" + isClienteAtivoPrimitivo()
				+ ", getValorPrimitivo()=" + getValorPrimitivo() + ", getIdadeWrapper()=" + getIdadeWrapper()
				+ ", getClienteAtivoWrapper()=" + getClienteAtivoWrapper() + ", getValorWrapper()=" + getValorWrapper()
